...
import { getComment, comment } from '../src/plugins/comment';
...
describe('comment', () => {
  ...
  it('should get type and description', () => {
    ...
    expect(String(result.options[0].description).trim()).to.equal('The options a.');
  });
  ...
  it('should ignore undefined titles', () => {
    ...
    expect(String(result.options[0].description).trim()).not.to.equal('The options a.');
  });
